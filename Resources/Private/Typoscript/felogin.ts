plugin.tx_felogin_pi1 {
	...
	templateFile >
	templateFile = {$template_path}/Resources/Private/Templates/Ext/tx_felogin/template.html
	...
	errorMessage_stdWrap {
		wrap = <div class="message message-error">|</div>
	}
	...
	userfields {
		...
		#redirect
	#redirectMode =  logout,groupLogin,userLogin,login,loginError
	redirectMode = groupLogin,userLogin,login,logout,loginError
	redirectFirstMethod =
	redirectPageLogin = 106
